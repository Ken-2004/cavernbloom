...
**Status:** early development. Player movement, static AABB collision, deterministic procedural generation, a scrolling 2D camera, flower collection, and goal progression are implemented.
